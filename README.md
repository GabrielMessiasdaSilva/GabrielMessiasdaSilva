...
Sou desenvolvedor backend focado em construir soluções escaláveis e eficientes.  
Atualmente estou trabalhando na construção de **agentes de Inteligência Artificial**, explorando automação, integração de sistemas e aplicações inteligentes.
